...
//CODE HERE
const compareNums = (first, second) => {
...
//CODE HERE
const affordance = (gold) => {
  return Math.floor(gold / 3)
}
let totalFrogs = affordance(0)
...
//CODE HERE
const affordance2 = (gold) => {
  return Math.floor(gold / 3)
}
let totalFrogs2 = affordance2(0)
...
//CODE HERE
const ascendancy = (array) => {
  for (let index in array) {
    if (array[Number(index) + 1] < array[index]) {
      return false
    }
  }
  return true
}
let arrayIsAscending = ascendancy(sampleArray)
